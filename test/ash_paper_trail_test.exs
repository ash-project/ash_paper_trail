  ...
  describe "changes in :full_diff mode" do
    ...
    test "create a new resource with embedded array", ctx do
      ...
      assert %{
               ...
               tags: %{
                 to: [
                   %{created: %{tag: %{to: "Ash"}, autogenerated_id: %{to: _id1}}, index: %{to: 0}},
                   %{created: %{tag: %{to: "Phoenix"}, autogenerated_id: %{to: _id2}}, index: %{to: 1}}
                 ]
               },
    ...
    test "update resource by adding to an array", ctx do
      ...
      %{tags: [%{autogenerated_id: ash_id}, %{autogenerated_id: phx_id}]} = res
IO.inspect(ash_id, label: "ash_id")

      ctx.resource.update!(res, %{
        tags: [%{tag: "Ash", autogenerated_id: ash_id}, %{tag: "nerves"}, %{tag: "Phoenix", autogenerated_id: phx_id}],
        lucky_numbers: [7, 8, 9]
      })
      ...
      assert %{
          tags: %{
            to: [
              %{created: %{tag: %{to: "Ash"}, autogenerated_id: %{to: ^ash_id}}, index: %{unchanged: 0}},
              %{created: %{tag: %{to: "nerves"}, autogenerated_id: %{to: _nerves_id}}, index: %{to: 1}},
              %{created: %{tag: %{to: "Phoenix"}, autogenerated_id: %{to: ^phx_id}}, index: %{to: 2, from: 1}}
            ]
          },
