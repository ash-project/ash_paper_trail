...
| [`versions_relationship_name`](#paper_trail-versions_relationship_name){: #paper_trail-versions_relationship_name } | `atom` | `:paper_trail_versions` | The name of the has_many relationship from this resource to its version resource. Defaults to `:paper_trail_versions`. |
...
| [`version_resource`](#paper_trail-version_resource){: #paper_trail-version_resource } | `atom` |  | Module for the auto-generated version resource. Defaults to `SourceResource.Version`. Set when that name is already used by another resource in your app. |
