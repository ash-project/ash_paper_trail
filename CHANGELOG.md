...
* redact sensitive fields nested inside embedded, union, and list values in versions (CVE-2026-77970) by [@zachdaniel](https://github.com/zachdaniel)

* avoid quadratic accumulator copying in full-diff list pairing (CVE-2026-77831) by [@zachdaniel](https://github.com/zachdaniel)

* mark version changes attribute sensitive based on tracked (not ignored) attributes (CVE-2026-75847) by [@zachdaniel](https://github.com/zachdaniel)
